...
class Decoder(nn.Module):
	...
	def __init__(self, z_dim=64, img_size=64):
		...
		self.layer1 = nn.Sequential(
							  nn.ConvTranspose2d(z_dim, 128, kernel_size=17, stride=1, padding=5),
							  nn.BatchNorm2d(128),
							  nn.ReLU(),
		...
		self.layer2 = nn.Sequential(
							  nn.ConvTranspose2d(128, 64, kernel_size=13, stride=2, padding=5),
							  nn.BatchNorm2d(64),
							  nn.ReLU(),
		...
		self.layer3 = nn.Sequential(
							  nn.ConvTranspose2d(64, 64, kernel_size=9, stride=2, padding=3),
							  nn.BatchNorm2d(64),
							  nn.ReLU(),
							  nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1),
							  nn.BatchNorm2d(64),
		...
		self.layer4 = nn.Sequential(
							  nn.ConvTranspose2d(64, 32, kernel_size=7, stride=2, padding=2),
							  nn.BatchNorm2d(32),
							  nn.ReLU(),
